...
Replace this section with reference implementations from your own features once you've built them. Suggested anchor patterns:

- A feature form pair: `use-<entity>-form.ts` + `<entity>-form.tsx` colocated under `apps/web/src/features/<feature>/components/<entity>-form/`.
- An auth form: `use-sign-in.ts` + `sign-in-form.tsx` under `apps/web/src/shared/components/sign-in-form/`.
