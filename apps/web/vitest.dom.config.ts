 ...
 * navigator, TanStack Router, authClient side effects). Split from the node
 * project so pure-function tests do not pay the jsdom boot cost.
 *
 ...
 * collide between sibling test files and the last-write-wins shape breaks
 * earlier tests.
 */
